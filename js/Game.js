...
Theodoric.Game.prototype = {
    ...
    create: function () {
        ...
        volumeSlider.addEventListener('input', () => {
            ...
            // Met à jour la musique principale
            this.music.volume = volume;

            // Met à jour tous les sons stockés
    ...
    playerHandler: function() {
        ...
        if (this.player.alive) {
            ...
            this.spellLabel.text = "Prêt à manger !";
                ...
                this.spellLabel.text = "en attente...";
            }
    ...
    attack: function(attacker, attacks) {
        ...
        if (attacker.alive && this.game.time.now > attacks.next) {
            ...
            // Cas spécial pour les spells : pas de sprite nécessaire
            if (attacks.name === 'spell') {
                attacker.health += 20; // applique l'effet
                console.log(attacker.name + " used " + attacks.name + "! Health is now " + attacker.health);
                return; // sortir, pas besoin de sprite
            }

            // Pour les autres attaques qui utilisent des sprites
            if (attacks.countDead() > 0) {
                ...
                if (attacks.name === 'sword') {
                    ...
                    a.rotation = this.game.physics.arcade.angleToXY(a, this.player.x, this.player.y);
    ...
    hit: function (target, attacker) {
        ...
        if (this.game.time.now > target.invincibilityTime) {
            ...
            this.notification = attacker.name + ' a infligé ' + attacker.strength + ' points de dégâts à ' + target.name + '!';
