...
Theodoric.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.image('playButton', 'assets/images/play.png?v=2');
		this.load.image('flame', 'assets/images/flame.png?v=2');
		this.load.image('sword', 'assets/images/sword.png?v=2');
		...
		this.load.spritesheet('tiles', 'assets/images/tiles.png?v=2', 16, 16);
		this.load.spritesheet('things', 'assets/images/things.png', 16, 16);
		this.load.spritesheet('characters', 'assets/images/characters.png?v=2', 16, 16);
		this.load.spritesheet('dead', 'assets/images/dead.png?v=2', 16, 16);
		...
		this.load.audio('openingMusic', 'assets/sound/opening2.ogg?v=2');
		this.load.audio('overworldMusic', 'assets/sound/overworld2.ogg?v=2');
		this.load.audio('attackSound', 'assets/sound/attack.wav?v=2');
		...
		this.sounds = {
			openingMusic: this.game.add.audio('openingMusic'),
			overworldMusic: this.game.add.audio('overworldMusic'),
			attackSound: this.game.add.audio('attackSound'),
			playerSound: this.game.add.audio('playerSound'),
			skeletonSound: this.game.add.audio('skeletonSound'),
			slimeSound: this.game.add.audio('slimeSound'),
			batSound: this.game.add.audio('batSound'),
			ghostSound: this.game.add.audio('ghostSound'),
			spiderSound: this.game.add.audio('spiderSound'),
			goldSound: this.game.add.audio('goldSound'),
			potionSound: this.game.add.audio('potionSound'),
